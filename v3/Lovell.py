...
def plot():
  ...
  ax0.tick_params(axis='both', which='both', direction='inout', labelleft='off')
  ...
  fig.subplots_adjust(left=0.17,right=.97,bottom=.15,top=.9)
...
if __name__ == '__main__':
  ...
  plot()
  plt.savefig('Lovell.pdf', format='pdf', dpi=300)
